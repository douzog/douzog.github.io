...
- **Delivered four public pitches and 40+ meetings with top-tier VC funds — 1st place at Photonics Days 2025 Berlin, 2nd place at Venture Vibe Deep Tech Summit.**
...
- Built ML-automated pipelines (Python, PyTorch, SciPy, Pandas, HDF5) for TCSPC data — curve-fitting, phasor analysis, ANOVA/PCA statistics, and quantitative image analysis of tau internalization.
...
- Built a Python pipeline to process FITS spectra — barycentric and interstellar velocity corrections, custom 0.02 Å binning — pushing detection sensitivity below 0.2% of the continuum; code released openly on GitHub.
...
- Evaluated latent representations with t-SNE, PCA, and K-means, validated by permutation testing — 78% classification accuracy on unseen data. Supervised by Prof. Dr. Birte U. Forstmann.
...
- Independent international musician performing across North America, Mexico, Israel, and Europe — live sets with synthesizers, samplers, mixers, and effects, and recorded collaborations worldwide. Represented in Europe by [LMNT agency](https://www.lmnt-agency.com/).
...
- Represented the station to the Miami public — booking artists, running giveaways, promoting events, and maintaining label and promoter relationships.
...
<img src="uchi/roddeal.webp" alt="Uchi performing live" width="340">
